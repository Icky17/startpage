...
// DOM-Elemente
let minutesDisplay, secondsDisplay, startBtn, resetBtn, modeBtns;
...
function resetTimer() {
  ...
  if (activeMode) {
    ...
    timeLeft = 45 * 60; // Standard: 45 Minuten
  }
  
  updateDisplay();
}

// Alarmsound abspielen
function playAlarmSound() {
  try {
    ...
    console.error("Fehler beim Abspielen des Alarmtons:", error);
  }
}